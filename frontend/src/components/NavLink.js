...
const NavLink = ({ active = false, children, ...props }) => {
    ...
    const activeStyles =
        "border-[#2d2d2d] text-[#2d2d2d] focus:border-[#2d2d2d]";
    const inactiveStyles =
        "border-transparent text-gray-500 hover:text-[#2d2d2d] hover:border-gray-300 focus:text-[#2d2d2d] focus:border-gray-300";
