...
const Dashboard = () => {
    ...
    const [roleName, setRoleName] = useState('Error')
    const roleMapping = {
        1: 'Viewer',
        2: 'Operator',
        3: 'Manager',
    ...
    const addOperation = () => {
        if (
            !newOperation.name ||
            !newOperation.startDate ||
            !newOperation.endDate
        ) {
                    ...
                    <div className="stats-section">
                        ...
                        <div className="stats-grid">
                            ...
                            <div className="stat-card">
                                ...
                                <p className="stat-number">
                                    {operations.filter(op => op.status === 'upcoming').length}
                                </p>
                                <button>Check</button>
                            </div>
                            <div className="stat-card">
