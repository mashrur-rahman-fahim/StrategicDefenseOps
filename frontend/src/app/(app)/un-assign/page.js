...
export default function UnAssign({ user }) {
    ...
    const handleUnassign = async () => {
        ...
        try {
            ...
            } else if ((role === 'operator' || role === 'viewer') && (userRole === 1 || userRole === 2)) {
                endpoint = `/api/${role}-unassign`
                data = { [`${role}Email`]: email, managerEmail }
            } else {
                setMessage("❌ You do not have permission to unassign this role.")
                return
            }
            ...
            <div className="card shadow-lg p-4">
                ...
                <div className="mb-3">
                    ...
                    >
                        ...
                        {userRole === 1 && <option value="manager">Manager</option>}
