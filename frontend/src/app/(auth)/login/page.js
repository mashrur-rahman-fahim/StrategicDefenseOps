        ...
        <div className="flex h-screen w-screen">
            ...
            <div className="flex-1 bg-[#b3b08d] flex items-center justify-center p-6 md:p-10">
                <div className="w-full max-w-lg">
                    <h2 className="text-4xl font-bold text-black font-[Stencil] text-center">LOGIN</h2>
                    ...
                    <form onSubmit={submitForm} className="mt-6">
                        ...
                        {/* Login Button */}
                        <button className="w-full bg-black text-white py-2 rounded-md mt-3 font-bold">Login</button>
                        ...
                        {/* Google Button */}
                        <button onClick={handleGoogleLogin} className="w-full bg-black text-white py-2 rounded-md font-bold">
